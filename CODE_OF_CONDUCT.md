...
- Interacting in project communities (online or in-person)
...
- Offensive comments related to gender, gender identity and expression, sexual orientation, disability, mental illness, neuro(a)typicality, physical appearance, body size, race, ethnicity, or other identity dimensions
...
2. Emailing the project contact email

### Investigation & Response
Reported violations will be investigated promptly. All reports will be kept confidential to the extent possible. The maintainers will:
...
- Reporting to relevant authorities when warranted
...
This Code of Conduct is adapted from the [Contributor Covenant](http://contributor-covenant.org), version 2.0, available at http://contributor-covenant.org/version/2/0/code_of_conduct.html
...
**We believe in building an inclusive, respectful, and welcoming community for everyone.**
